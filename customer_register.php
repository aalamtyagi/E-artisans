...
<input type="text" class="form-control" name="c_name" pattern="[a-zA-z' ']{5,15}" required>
...
<input type="password" class="form-control" id="pass" name="c_pass" pattern="[a-zA-Z0-9' ']{5,15}" required>
...
<input  type="tel" id="phone" name="phone"
       pattern="[0-9]{10}" class="form-control" name="c_contact" required>
